...
import CheckoutPage from "./components/CheckoutPage.jsx";
import OrderConfirmationPage from "./components/OrderConfirmationPage.jsx";
import LifestylePage from "./components/Lifestyle.jsx";
import { Toaster } from "react-hot-toast";
...
const App = () => {
  ...
  return (
    <Router>
      ...
      {/* ✅ Navigation always visible except home */}
      <Routes>
        <Route
          path="/"
          element={<HomePage setCurrentCategory={setCurrentCategory} />}
        />
        <Route
          path="*"
          element={
      ...
      <Routes>
        <Route
          path="/categories"
          element={<CategoriesPage setCurrentCategory={setCurrentCategory} />}
        />
        <Route
          path="/lifestyle"
          element={<LifestylePage setCurrentCategory={setCurrentCategory} />}
        />
        <Route
          path="/products"
          element={
